# 定义 OpenAI 请求 DTO 最小契约

## Goal
当系统接收 OpenAI Compatible 请求时，系统应使用统一请求 DTO 结构进行解析。

## Contract Context
OpenAI Compatible 请求协议。
...
### Commands
* `go test ./internal/protocol/openai -run '^TestOpenAIRequestDTOContract$' -count=1 -cover`

### Expected Results
* 至少 5 个用例通过。
* model/messages/stream 字段断言通过率 100%。
